...
export async function GET() {
  ...
  try {
    ...
    const [leadsResult, emailResult, smsResult, repliesResult] = await Promise.all([
    ...
    return NextResponse.json({ leads: leadsResult.data, emails: emailResult.data, sms: smsResult.data, replies: repliesResult.data, metrics });
  } catch (error) {
