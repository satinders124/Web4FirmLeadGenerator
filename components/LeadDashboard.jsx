...
const defaultForm = { query: "restaurants", location: "Brisbane, QLD, Australia", minRating: "4", minReviews: "10" };
    ...
    <div className="lead-app-shell">
      ...
      <div className="lead-workspace">
        <aside className="lead-sidebar">
          ...
          <div className="lead-stats"><div><b>{totals.found}</b><span>Found</span></div><div><b>{totals.noWebsite}</b><span>No website</span></div><div><b>{contacted}</b><span>Contacted</span></div></div>
