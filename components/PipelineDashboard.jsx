...
export default function PipelineDashboard() {
  ...
  const repliesByLead = useMemo(() => {
    const grouped = new Map();
    (data?.replies || []).forEach((reply) => grouped.set(reply.lead_id, (grouped.get(reply.lead_id) || 0) + 1));
    return grouped;
  }, [data]);
